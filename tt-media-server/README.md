...
| inline base64 | `MEDIA_INLINE_MAX_BYTES` | 64 MiB | ~35 min of 16 kHz mono PCM16. Held below the fetched cap because the request-body path costs ~1.5× the memory, and 1 GiB inline would be 1.33 GiB resident in a single request. |
